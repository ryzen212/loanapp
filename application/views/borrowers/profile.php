                        ...
                        <div class="col-md-4">
                            <div class="card card-profile">
                                <div class="card-avatar" style="height: 150px">
                                    ...
                                    <?php } else { ?>
                                        <img class="border-round" src="<?php echo base_url() . 'assets/uploads/' . $profile['prof-img']; ?>" width="150" height="150" />
                                    <?php } ?>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-sm" id="loan_history">
                                            ...
                                            <tbody>
                                                ...
                                                if (!empty($loan)) {
                                                    foreach ($loan as $key => $value) {
                                                        $totalLoanAmount += $value['loan_amount']; // Accumulate loan amounts
                                                ?>
                                                        <tr>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="4" class="text-right font-weight-bold">Total Loan Amount: <?php echo number_format($totalLoanAmount, 2, '.', ','); ?> PHP</td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                                ...
                                                <?php if (!empty($co_maker)) { ?>
                                                    <?php foreach ($co_maker as $key => $cmaker) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php $time = $cmaker['date_issued'];
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="date" class="form-control" name="bday" value="<?php echo $profile['birthdate']; ?>" required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
