<body class="">
    ...
    <div class="wrapper ">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body container-fluid">
                                            <div class="table-responsive">
                                                <table class="table-hover" id="new_client_table">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    ...
                                                                                    <?php } else { ?>
                                                                                        <img class="border-round" src="<?php echo base_url() . 'assets/uploads/' . $newC['profile_img']; ?>" width="150" height="150" />
                                                                                    <?php } ?>
                                                                                </div>
                                                                                <div class="col-md-8">
        ...
        <?php $this->load->view('templates/change_pass') ?> <?php $this->load->view('templates/footer') ?> </body>
