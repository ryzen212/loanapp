<div class="sidebar" data-color="orange" data-background-color="white" >
	...
	<a href="#" class="simple-text logo-normal font-weight-bold" style="word-wrap: break-word; font-size: 0.vw; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
    <img src="<?php echo base_url();?>/assets/images/lms.png" alt="Company Logo" height="30" width="30"> NP Karis Mast Lending Corporation </a>
...
<script>
    $(document).ready(function() {
        ...
        $window.on('resize', function() {
            ...
            var wi<div class="sidebar" data-color="orange" data-background-color="white" >
		<!--
			Tip 1: You can change the color of the sidebar using: data-color="orange | azure | green | orange | danger"

			Tip 2: you can also add an image using data-image tag
		-->
	<div class="logo m-1 form-group">
		
		<a href="#" class="simple-text logo-normal font-weight-bold"><img src="<?php echo base_url();?>/assets/images/lms.png" height="50" width="50"> LMS Corporation</a>
	</div>
	<?php $site = $_SERVER['PATH_INFO'];?>
	<div class="sidebar-wrapper">
		<ul class="nav">
