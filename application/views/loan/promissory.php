                       ...
                       <div class="card"> 
                            <div class="card-body mr-5 ml-5">
                                <div class="text-center">
                                    <h3 class="mb-0 font-weight-bold">NP Karis Mast Lending Corporation</h3>
                                </div>
                                <div class="row">
                                    <div class="col-4"></div>
                                    <div class="col-4 text-center">
                                        <p class="mb-0 l-font"> Odiongan, Romblon and Sta. Maria, Romblon</p>
                                        <p class="l-font">0917 6556108; 09392489557; 09472156549</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-inline ml-5 pl-3">
                                            <label class="text-dark l-font">NO:</label>
                                ...
                                <div class="form-inline">
                                    ...
                                    <div style="margin-left: 20px;">
                                        <ol class="l-font">
                                            ...
                                            <li  style="margin-bottom: 20px">That in case of illigation arising from or in connection with this note the venue of any be filed shall be at decision of the creditors, the proper court in the Province of Romblon to the exclusion of other courts.</li>
                                        </ol>
                                    </div>
                                    <div>
                                        <p class="l-font"><span style="margin-left: 50px; margin-bottom: 10px">IN </span>WITNESS WHEREOF, I / WE have here unto set my hand this <input class="text-p text-center font-weight-bold" value="<?php echo date('d');?>">th day of <input class="text-p text-center font-weight-bold" value="<?php echo date('M');?>"> <input class="text-p text-center font-weight-bold" value="<?php echo date('Y');?>">, at Odiongan, Romblon, Philippines.</p>
                                    </div>
                                <div class="col-12 mt-3">
                                    <div class="row">
                                        <div class="col-5 border border-dark">
                                            <h5 class="font-weight-bold mt-1 text-center" style="font-size: 15px">NP KARIS MAST LENDING CORPORATION</h5>
                                            <div class="form-inline">
                                ...
                                <div>
                                    ...
                                    <p class="l-font">PROVINCE OF ROMBLON......................)S.S</p>
                                </div>
        

                                <p class="l-font"><span style="margin-left: 50px; margin-bottom: 10px">BEFORE ME,</span> a notary for and in the Province of Romblon, Philippines this <input class="text-p" style="width: 50px;" type="" name=""> day of <input style="width: 200px;" class="text-p"> 20<input class="text-p" style="width: 50px;">. Personally appeared <input class="text-p" style="width: 500px;" type="text" name="">with respective Res. Cert. Above stated, known to me and to me know to be the same person who executed the foregoing instrument and the acknowledged to me the same their own and voluntary act and deed.</p>
